...
<table border="0" width="100%" height="auto" class="bg"  >
<tr width="100%" height="15%" colspan="3" >
<td width="20%" ><img src="..\image\bietcoderlogo.png" height="40%" border="0" style="left-margin:0;" width="50%"  >
</td>
<td width="40%" >
<a href="home.html" class="atext" >
<i><u>BIETcoders</u></i></a>
</td>
<td width="35%">
</br>
...
<p>
<b class="btext">Username </b> <input type="text" class="ztext" name="username">
</p>
<p>
</br> <b class="btext">Password </b> <input type="password" class="ztext" name="password">
</p>
<input type="submit" value="Login" class="pink12" border="0" >
<a href="forget.php" class="ctext" >  Forget  &nbsp  Account </a> </form></td></p>
</tr>
...
<div id="sp1">
<h1 align="top" style="color:blue;font-weight:bold;font-style:Cooper;font-size:50;" >Signup for BIETcoders</h1>
</div>
<div id="sp2" align="center">
<form action="signup.php" method="post"  >
</br> <input type="text" placeholder=" Rollno" name="rollno" style="font-size:20;" class="ztext3"></br></br>
...
<input type="numbers" placeholder=" Mobile No"  name="mobile"  style="font-size:20;" class="ztext3"> </br></br>
<input type="text" placeholder=" User Name"  name="username"  style="font-size:20;" class="ztext3"></br> </br>
...
<input type="submit" class="pink12" style="font-size:0; value="Sign up" "></br></br>
</form> 
</div>
</td>
</tr>
